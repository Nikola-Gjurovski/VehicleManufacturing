...
namespace VehicleReposiotry.Migrations
{
    ...
    [Migration("20240618121137_getShoppingCardForProducts")]
    partial class getShoppingCardForProducts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShoppingCartVehicleParts", b =>
                {
                    ...
                    b.Property<Guid>("ProductShoppingCartsId1")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ProductShoppingCartsId", "ProductShoppingCartsId1");

                    b.HasIndex("ProductShoppingCartsId1");
            ...
            modelBuilder.Entity("ShoppingCartVehicleParts", b =>
                {
                    ...
                    b.HasOne("Domain.VehicleParts", null)
                        .WithMany()
                        .HasForeignKey("ProductShoppingCartsId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
